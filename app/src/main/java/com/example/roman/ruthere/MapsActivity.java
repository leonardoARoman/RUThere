...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        String[] latLng = ((String) getIntent().getSerializableExtra("LatLng")).split(" ");
        LatLng currentLoacation = new LatLng(Double.parseDouble(latLng[0]), Double.parseDouble(latLng[1]));
